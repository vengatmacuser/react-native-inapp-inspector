...
export const BrandSquareIcon = ({size = 56}: {size?: number}) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" fill="none">
      ...
      {/* Rounded Squircle Tile & Border */}
      <Rect x={8} y={8} width={240} height={240} rx={58} fill="url(#sq_tile)"/>
      <Rect x={8.6} y={8.6} width={238.8} height={238.8} rx={57.4} fill="none" stroke="url(#sq_edge)" strokeOpacity={0.6}/>
      <Circle cx={128} cy={128} r={104} fill="url(#sq_halo)"/>

      {/* Full-body Cyber Debugger Owl */}
      <G transform="translate(128 128) scale(1.16) translate(-128 -134)">
        {/* wing 1 */}
        <Path d="M74 124 C58 154 60 190 86 204 C79 176 77 148 88 126 Z" fill="url(#sq_wing)" stroke="url(#sq_beam)" strokeWidth={2.5} strokeOpacity={0.45}/>
        {/* wing 2 */}
        <Path d="M182 124 C198 154 196 190 170 204 C177 176 179 148 168 126 Z" fill="url(#sq_wing)" stroke="url(#sq_beam)" strokeWidth={2.5} strokeOpacity={0.45}/>
        {/* body */}
        <Path d="M62 150 C58 104 70 70 90 58 L98 42 L116 62 Q128 57 140 62 L158 42 L166 58 C186 70 198 104 194 150 C198 180 184 204 152 212 C140 216 116 216 104 212 C72 204 58 180 62 150 Z" fill="url(#sq_owlbody)" stroke="url(#sq_beam)" strokeWidth={4} strokeLinejoin="round"/>
        ...
        {/* belly plate */}
        <Path d="M128 126 C151 126 164 148 162 174 C160 198 146 212 128 212 C110 212 96 198 94 174 C92 148 105 126 128 126 Z" fill="url(#sq_belly)"/>
        ...
        <Rect x={107} y={161} width={42} height={32} rx={9} fill="#0C1426" stroke="url(#sq_beam)" strokeWidth={2} strokeOpacity={0.7}/>
        ...
        {/* facial disc */}
        <Path d="M128 92 C148 70 186 78 186 108 C186 134 160 152 128 152 C96 152 70 134 70 108 C70 78 108 70 128 92 Z" fill="url(#sq_faceplate)" stroke="#52709E" strokeWidth={2.6} strokeOpacity={0.7}/>
        {/* facial-disc centre ridge */}
        <Path d="M128 96 L128 120" stroke="#52709E" strokeWidth={2} strokeLinecap="round" strokeOpacity={0.45}/>

        {/* feet */}
        <G stroke="url(#sq_beak)" strokeWidth={5} strokeLinecap="round" fill="none">
        ...
        {/* rosy cheeks */}
        <Ellipse cx={83} cy={127} rx={9} ry={6} fill="url(#sq_blush)"/>
        <Ellipse cx={167} cy={122} rx={9} ry={6} fill="url(#sq_blush)"/>
      </G>
    </Svg>
  );
};
