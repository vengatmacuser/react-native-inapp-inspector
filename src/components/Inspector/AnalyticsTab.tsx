...
const AnalyticsHeader = React.memo(() => {
  ...
  const [isRealtimeExpanded, setIsRealtimeExpanded] = useState(false);
  ...
  // If there are no analytics events in the session, hide the realtime card
  ...
  // Category counts & revenue across all session events
  ...
  return (
    <View style={styles.analyticsHeaderCard}>
      {/* ── 1. Accordion Header Row (Toggles Realtime Activity) ─────────────── */}
      <TouchableOpacity
        activeOpacity={0.7}
        onPress={() => {
          animateNextLayout();
          setIsRealtimeExpanded(prev => !prev);
        }}
        style={{
          flexDirection: 'row',
        ...
        <View style={{flexDirection: 'row', alignItems: 'center', gap: 8}}>
          ...
          <ChevronIcon
            direction={isRealtimeExpanded ? 'up' : 'down'}
            size={16}
      ...
      {/* ── 2. Collapsible Realtime Activity Content (Collapsed by Default) ── */}
      {isRealtimeExpanded && (
    ...
    <>
      ...
      {selectedEvent == null && (
        <View
          ...
          {/* ── Category Filters ScrollBar (Under Search) ────────────────── */}
          <ScrollView
            horizontal
            ...
            {/* All Filter */}
            {(() => {
              const active = analyticsFilters.categories.has('all');
              return (
                <TouchableScale onPress={() => toggleCategoryFilter('all')}>
                  <View
                    style={[
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center', gap: 6}}>
                      ...
                      <Text
                        ...
                        {t('common.all', 'All')} ({categoryStats.totalCount})
                      </Text>
                    </View>
                  </View>
                </TouchableScale>
            ...
            {(() => {
              ...
              return (
                <TouchableScale onPress={() => toggleCategoryFilter('ecommerce')}>
                  <View
                    style={[
                      styles.statusFilterChip,
                      {
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center', gap: 6}}>
                      ...
                      <Text
                        ...
                        Ecommerce ({categoryStats.ecommerce})
                      </Text>
                    </View>
                  </View>
                </TouchableScale>
            ...
            {(() => {
              ...
              return (
                <TouchableScale onPress={() => toggleCategoryFilter('page_view')}>
                  <View
                    style={[
                      styles.statusFilterChip,
                      {
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center', gap: 6}}>
                      ...
                      <Text
                        ...
                        Screens ({categoryStats.page_view})
                      </Text>
                    </View>
                  </View>
                </TouchableScale>
            ...
            {(() => {
              ...
              return (
                <TouchableScale onPress={() => toggleCategoryFilter('system')}>
                  <View
                    style={[
                      styles.statusFilterChip,
                      {
                        backgroundColor: active ? AppColors.violet600 : AppColors.purple100,
                        borderColor: active ? AppColors.purpleShade700 : AppColors.purple200,
                        borderRadius: 8,
                        paddingHorizontal: 10,
                        paddingVertical: 6,
                      },
            ...
            {(() => {
              ...
              return (
                <TouchableScale onPress={() => toggleCategoryFilter('custom')}>
                  <View
                    style={[
                      styles.statusFilterChip,
                      {
                        backgroundColor: active ? AppColors.pink600 : AppColors.pink100,
                        borderColor: active ? AppColors.rose700 : AppColors.roseBorder,
                        borderRadius: 8,
                        paddingHorizontal: 10,
                        paddingVertical: 6,
                      },
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center', gap: 6}}>
                      ...
                      <Text
                        ...
                        style={[
                          styles.statusFilterText,
                          {
                            color: active ? AppColors.white : AppColors.pink600,
                            fontFamily: AppFonts.interBold,
                          },
                        ]}>
                        Custom ({categoryStats.custom})
                      </Text>
                    </View>
                  </View>
                </TouchableScale>
